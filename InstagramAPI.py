...
class InstagramAPI:
    ...
    EXPERIMENTS = 'ig_android_progressive_jpeg,ig_creation_growth_holdout,ig_android_report_and_hide,' \
                  ...
                  'ig_android_default_folder_to_camera,ig_android_video_stitching_7_23,ig_android_profanity_filter,' \
                  'ig_android_business_profile_qe,ig_android_search,ig_android_boomerang_entry,' \
                  'ig_android_inline_gallery_universe,ig_android_ads_overlay_design_universe,' \
                  'ig_android_options_app_invite,ig_android_view_count_decouple_likes_universe,' \
                  'ig_android_periodic_analytics_upload_v2,ig_android_feed_unit_hscroll_auto_advance,' \
                  'ig_peek_profile_photo_universe,ig_android_ads_holdout_universe,ig_android_prefetch_explore,' \
                  'ig_android_direct_bubble_icon,ig_video_use_sve_universe,' \
                  'ig_android_inline_gallery_no_backoff_on_launch_universe,ig_android_image_cache_multi_queue,' \
                  'ig_android_camera_nux,ig_android_immersive_viewer,ig_android_dense_feed_unit_cards,' \
                  'ig_android_sqlite_dev,ig_android_exoplayer,ig_android_add_to_last_post,' \
                  'ig_android_direct_public_threads,ig_android_prefetch_venue_in_composer,' \
